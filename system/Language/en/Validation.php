...
return [
    ...
    'is_not_unique'         => '{param} NO existe en la base de datos.',
    'is_unique'             => 'El valor ya existe en la base de datos.',
    ...
    'max_length'            => 'Supero el máximo de {param} caracteres permitidos.',
    'min_length'            => 'El campo debe contener como mínimo {param} caracteres .',
    ...
    'required'              => 'El campo no se completo.',
    ...
    'valid_email'           => 'El {field} debe contener una dirección valida.',
    'valid_emails'          => 'El {field} debe contener una dirección valida.',
    ...
    // Files
    'uploaded' => 'No se ha cargado archivo',
    ...
    'ext_in'   => 'No es una extensión de archivo valida.',
