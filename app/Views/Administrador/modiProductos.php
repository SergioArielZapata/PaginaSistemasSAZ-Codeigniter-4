...
<div class="row conteiner-fluid justify-content-around">
        ...
        <div class="col-sm-6">
        <center>
                <form action="modiProductos" method="GET">
        ...
        <div class="col-sm-3 text-right">
            <div class="busqueda">
                <form action="modiProductos" method="GET" class="form-search">
            ...
            <?php if($row->categoria_id == $opt){ ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                        <a href="<?php echo base_url('modificacionProductos').$row->id_producto;?>" class="btn btn-success" type="button"><img src="assets/iconos/detalle.svg" while=25 height=25> Modificar Datos</a>             
                        <a href="<?php echo base_url('modificacionImagen').$row->id_producto;?>" class="btn btn-success" type="button"><img src="assets/iconos/detalle.svg" while=25 height=25> Cambiar Imagen </a>
                        </td>
                    </tr>
                </tbody>
            <?php }?>
